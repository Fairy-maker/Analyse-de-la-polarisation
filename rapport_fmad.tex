...
Exemple : si pour le vote $a \in p$, $c_i$ est en position 3, et que pour $b$ elle est en position 2, alors la distance est de 1 $(d(a,b))$. Pour $d(b,a)$ on obtient :  $|r_b(i) - r_a(i)| = |2-3| = |-1| = 1 = d(a,b)$
\\
...
&\leq \sum_{i=1}^m \big(|r_a(i) - r_c(i)| + |r_c(i) - r_b(i)|\big) \text{ par l'inégalité triangulaire de la valeur obsolue}\\
